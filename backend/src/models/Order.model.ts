...
export interface IOrder extends Document {
  ...
  orderStatus: "Pending" | "Processing" | "Shipped" | "Delivered" | "Cancelled" | "Refunded" | "Payment Failed";
  isPaid: boolean;
  paidAt?: Date;
  isDelivered: boolean;
  deliveredAt?: Date;
...
OrderSchema.pre<IOrder>("save", function (next) {
  if (this.isModified("itemsPrice") || this.isModified("taxPrice") || this.isModified("shippingPrice") || this.isNew) {
